      ...
      <div
        ...
        <div className=''>
          ...
          <div className='flex flex-col mt-5'>
            ...
            const uniqueTasks = taskList?.reduce<{ groups: string[]; supervisors: string[]; items: typeof taskList }>(
              (acc, task) => {
            ...
            // const uniqueGroups: string[] = []
                // const uniqueSupervisors: string[] = []

                // return taskList?.map((task, index) => {
                //   const randomIndex = Math.floor(Math.random() * 10)
                //   const isGroupUnique = !uniqueGroups.includes(
                //     task.sup_group_name
                //   )
                //   const isSupervisorUnique = !uniqueSupervisors.includes(
                //     task.supervisor_name
                //   )

                //   if (isGroupUnique) uniqueGroups.push(task.sup_group_name)
                //   if (isSupervisorUnique)
                //     uniqueSupervisors.push(task.supervisor_name)
...
//             group: Array.from(
//               new Set(
//                 result.map((row) => row.sup_group_name && row.supervisor_name)
//               )
//             ),
//             product: Array.from(new Set(result.map((row) => row.chtitle))),
//           })
//       })
//     }
//     getData()
