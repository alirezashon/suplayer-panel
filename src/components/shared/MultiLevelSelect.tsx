...
// ) => {
//   setSelected((prev) => {
//     const newSelection = prev[level].includes(id)
//       ? prev[level].filter((item) => item !== id)
//       : [...prev[level], id]
...
//       <div
//         className='border border-gray-300  rounded-md h-10   px-4 cursor-pointer flex justify-between items-center'
//         onClick={() => setIsOpen((prev) => !prev)}>
//         <span className='text-gray-700'>desd</span>
//         <span className='text-gray-400'>&#x25BC;</span>
//       </div>
//       {isOpen && (
//         <div className='border-2 p-1'>
//           <div className='sticky top-0  w-full  flex items-center mt-5 mb-8'>
...
//                     <div
//                       key={child.id}
//                       className='border p-2 rounded-md bg-white my-1 shadow-lg shadow-purple-200 hover:bg-purple-300'>
//                       <div
//                         className='flex justify-between items-center '
//                         onClick={() => handleSelection('level2', child.id)}>
...
//                         <ArrowDown2 size={24} color='#7747C0' />
//                       </div>
//                       {selected.level2.includes(child.id) && child.children && (
//                         <div className='my-3 mx-4  bg-white border border-purple-300 rounded shadow-md shadow-purple-300 '>
//                           <div className='sticky top-0  w-full  flex items-center mt-5 mb-8'>
//                             <div className='absolute left-10 mt-4 z-20 cursor-pointer text-[#50545F]'>
//                               <SearchNormal size={24} color='gray' />
//                             </div>
...
//                             <label
//                               key={subChild.id}
//                               className='flex items-center gap-2 px-3 cursor-pointer hover:bg-purple-400'>
//                               <input
//                                 type='checkbox'
//                                 className='accent-[#7747C0] w-4 cursor-pointer'
//                                 checked={selected.level3.includes(subChild.id)}
//                                 onChange={() =>
//                                   handleSelection('level3', subChild.id)
//                                 }
//                               />
//                               {subChild.label}
//                             </label>
...
//         <h4>موارد انتخاب‌شده:</h4>
//         <p>گروه ۱: {selected.level1.join(', ')}</p>
//         <p>گروه ۲: {selected.level2.join(', ')}</p>
//         <p>گروه ۳: {selected.level3.join(', ')}</p>
//       </div>
//     </div>
//   )
// }
  ...
  return (
    <div className='p-4' ref={containerRef}>
      ...
      <div
        ...
        <span className='text-gray-700'>انتخاب کنید</span>
        <span className='text-gray-400'>&#x25BC;</span>
      </div>
      {isOpen && (
        <div className='border-2 p-1'>
