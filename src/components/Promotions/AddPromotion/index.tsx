          ...
          {step === 1 ? (
            <div className='flex justify-center'>
              <div className='flex flex-col w-[67%]  gap-3'>
                ...
                {hasCornometer && (
                  <div className='flex gap-3 mb-1'>
                    <Calendar
                      ...
                      hasError={errors.exp_date ? true : false}
                      setDate={(value: string) =>
                        (refs.current.promo_start_date = value)
                      }
                    />
                    <TimePicker
                      ...
                      setData={(value: string) =>
                        (refs.current.promo_start_time = value)
                      }
                    />
                    <Calendar
                      placeholder='تاریخ پایان'
                      hasError={errors.exp_date ? true : false}
                      setDate={(value: string) =>
                        (refs.current.promo_exp_date = value)
                      }
                    />
                    <TimePicker
                      ...
                      hasError={errors.exp_date ? true : false}
                      setData={(value: string) =>
                        (refs.current.promo_exp_time = value)
                      }
                    />
                  </div>
                )}
                ...
                <ImageUploader
                  setFileUid={(result: string) =>
                    (refs.current.file_uid = result)
                  }
                  draftSrc={draftSrc}
                ...
                <div>
                  <div className='flex w-full flex-col gap-3'>
                    <div className='col-span-2'>
                      ...
                      <textarea
                        name='promo_desc'
                        value={refs.current.promo_desc || ''}
                        onChange={handleInputChange}
                        className=' p-2 rounded-md outline-none resize-none w-full border-2 '
