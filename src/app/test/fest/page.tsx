  ...
  return (
    <div className='relative inline-block m-96' ref={wrapperRef}>
      <input
        ...
        value={formattedTime}
        className='w-32 p-2 border rounded cursor-pointer text-center'
      />
      {open && (
        <div className='absolute z-10 top-12 left-1/2 -translate-x-1/2 p-2 bg-gray-100 border-purple-500 border shadow-md rounded-full w-64 h-64 flex items-center justify-center'>
